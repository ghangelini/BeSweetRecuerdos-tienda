...
import { formatCategoryLabel, normalizeCategory, PRODUCT_CATEGORIES } from '@/lib/products';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const productToSave = {
        ...
        category: normalizeCategory(formData.category) || null,
      };
      ...
      <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden border border-gray-100 flex flex-col max-h-[90vh]">
        <div className="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Completa los datos del producto</p>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <form id="admin-product-form" onSubmit={handleSubmit} className="overflow-y-auto p-8 space-y-6">
          {error && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-all text-sm"
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-700">Orden en tienda</label>
              <input
                type="number"
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-all text-sm text-gray-400"
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-all text-sm resize-none"
              placeholder="Describe los ingredientes, el tamaño..."
            />
          </div>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <div className="relative">
                <button
                  type="button"
                  className="text-xs font-bold text-pink-600 hover:text-pink-700 bg-pink-50 px-3 py-1.5 rounded-lg border border-pink-100 transition-colors flex items-center gap-2"
                >
                  <Upload size={14} />
                  Subir fotos
                </button>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {formData.image && (
                <div className="relative group aspect-square rounded-2xl overflow-hidden border-2 border-pink-500 shadow-md">
                  <img src={formData.image} alt="Principal" className="w-full h-full object-cover" />
                  <div className="absolute top-2 left-2 block px-2 py-0.5 bg-pink-500 text-[9px] font-bold text-white rounded-full">
                    PRINCIPAL
                  </div>
              ...
              {formData.images?.map((url, idx) => (
                <div
                  key={idx}
                  className="relative group aspect-square rounded-2xl overflow-hidden border border-gray-100 bg-gray-50 shadow-sm hover:shadow-md transition-all"
                >
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                    <button
                      ...
                      className="text-white hover:text-pink-400 p-1.5 bg-white/10 rounded-full hover:bg-white/20"
            ...
            <p className="text-[10px] text-gray-400 italic">
              La primera imagen será la portada. Puedes elegir varias a la vez y usar la estrella para cambiar la principal.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 bg-pink-50/50 p-4 rounded-2xl border border-pink-100">
            <input
              ...
              className="w-5 h-5 rounded text-pink-600 focus:ring-pink-500 border-pink-200"
            />
            <label htmlFor="isFeatured" className="text-sm font-bold text-pink-900 cursor-pointer">
        ...
        <div className="px-8 py-6 border-t border-gray-100 bg-gray-50/50 flex justify-end gap-3">
          ...
          <button
            ...
            className="px-8 py-2.5 bg-pink-500 hover:bg-pink-600 disabled:bg-gray-300 text-white text-sm font-bold rounded-xl shadow-lg shadow-pink-200 transition-all flex items-center gap-2"
          >
